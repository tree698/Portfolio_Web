...
export default function CardButtons({ filter }) {
  ...
  const STYLE_BUTTON =
    'relative border border-superLightGray mx-1 lg:mx-2 py-1 px-4 md:px-6 lg:px-8 rounded-md hover:scale-105 transition-all delay-150 duration-300 ease-in-out';
  const STYLE_NUMBER =
    'w-8 h-8 leading-8 absolute -top-4 -right-1 text-xl rounded-full bg-primaryAccent text-white';
